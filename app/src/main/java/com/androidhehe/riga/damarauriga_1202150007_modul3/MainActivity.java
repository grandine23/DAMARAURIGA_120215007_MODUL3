...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeData() {
        ...
        String[] waterList = getResources().getStringArray(R.array.produk);
        String[] waterInfo = getResources().getStringArray(R.array.pro_info);
        TypedArray waterImageResources = getResources().obtainTypedArray(R.array.pro_images);
